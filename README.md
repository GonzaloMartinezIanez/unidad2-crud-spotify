...
También he decidido que a la hora de insertar nuevas canciones y artistas, en la petición se escriba el nombre y no el id. De esta forma es más amigable para el usuario ya que no tiene que ir a la aplicación de spotify, seleccionar la canción y obtener el id.\
